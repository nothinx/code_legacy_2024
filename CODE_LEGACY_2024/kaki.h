...
#define tibia 75  // Panjang segmen Tibia (betis dari sendi kedua ke ujung kaki)
...
int tinggiLangkah = 65;  // Tinggi langkah kaki saat diangkat dari tanah (dibagi rateKu harus bulat)
